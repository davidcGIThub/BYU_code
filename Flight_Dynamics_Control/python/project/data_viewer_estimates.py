...
class data_viewer_estimates:
    def __init__(self):
        ...
        self.plotter.define_input_vector('estimated_state_2', ['pn_e', 'pe_e', 'h_e', 'Va_e', 'alpha_e', 'beta_e',
                                                             'phi_e', 'theta_e', 'chi_e', 'p_e', 'q_e', 'r_e',
                                                             'Vg_e', 'wn_e', 'we_e', 'psi_e', 'bx_e', 'by_e', 'bz_e'])
        # plot timer
        self.time = 0.
    ...
    def update(self, true_state, estimated_state, estimated_state2, ts):
        ...
        self.plotter.add_vector_measurement('estimated_state_2', estimated_state_list2, self.time)
